        ...
        for j in 97..123 {
            for k in 97..123 {
                ...
                for word in &words {
                    let mut res= 0;
                    if counter == 0 {
                        res = word.parse::<u8>().unwrap() ^ i;
                        counter += 1
                    } else if counter == 1 {
                        res = word.parse::<u8>().unwrap() ^ j;
                        counter += 1;
                    } else if counter == 2 {
                        res = word.parse::<u8>().unwrap() ^ k;
                        counter = 0;
                    }
                    total += res as u64;
                    s.push(res as char);
